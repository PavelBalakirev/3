...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (matcher.find()) {
            ...
            int end=matcher.end();
            Number.add(text.substring(start,end));
            System.out.println("Обнаружено совпадение " + text.substring(start,end) + " с "+ start + " по " + (end-1) + " позицию");
        }
        Collections.sort(Number);
        System.out.println(Number);
        writeHtml(Number, "output.txt");
    }
